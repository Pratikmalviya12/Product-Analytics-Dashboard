            ...
            <div className="relative z-10 pr-12 sm:pr-16">
              ...
              <div className="mb-4 lg:mb-6">
                <h1 className="text-gray-900 dark:text-white text-xl sm:text-2xl lg:text-3xl mb-2 lg:mb-3 font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent">
                  <span className='text-white'>📊</span> Product Analytics Dashboard
                </h1>
              ...
              <div className="flex flex-wrap gap-2 lg:gap-3 items-center mb-4 lg:mb-6">
                ...
                {dataSource === 'ga4' && ga4Config.isAuthenticated && (
                  ...
                  >
                    <span className={`w-2 h-2 rounded-full ${isRealtimeActive ? 'bg-red-500 animate-pulse' : 'bg-green-500'}`}></span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    ...
                    onChange={(e: React.ChangeEvent<HTMLSelectElement>) => 
                      setFilters({ selectedCountry: e.target.value === 'all' ? null : e.target.value })
                    }
                  ...
                  >
                    <option value="all" className="text-gray-800 dark:text-gray-200">
                      All Countries
                    </option>
                    {uniqueCountries.map((country) => (
                      <option key={country} value={country} className="text-gray-800 dark:text-gray-200">
                        {country}
                      </option>
                    ))}
                  </Select>
          ...
          {isLoadingGA4 && (
            <section className="mb-4 lg:mb-6">
              <Card className="text-center py-8 lg:py-12">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-base lg:text-lg font-medium">Loading GA4 data...</p>
